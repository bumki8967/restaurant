...
public class NaverLoginBO {
    ...
    //private final static String REDIRECT_URI 	= "http://localhost:8095/login/naver";	// callback URI
    private final static String REDIRECT_URI 	= "http://139.150.65.179/login/naver";	// callback URI
